...
- **Positional effects create uneven capacity.** The same information contributes differently to effective capacity depending on where it sits in the context. Early tokens have outsized influence due to autoregressive trajectory commitment; tokens in the "lost in the middle" zone contribute less than their count suggests.
