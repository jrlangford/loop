...
description: Evaluate a semantic gate for the Loop design pipeline in clean context. Use for semantic gate checks during /loop:design, /loop:edit, /loop:reverse, or /loop:add-workflow workflows.
